...
class ProjectManagementRequestHandler {
    ...
    getAndroidShaCertificates(parentResourceName) {
        return this.invokeRequestHandler('GET', `${parentResourceName}/sha`,  null, 'v1beta1');
    }
    ...
    getConfig(parentResourceName) {
        return this.invokeRequestHandler('GET', `${parentResourceName}/config`,  null, 'v1beta1');
    }
    
    getResource(parentResourceName) {
        return this.invokeRequestHandler('GET', parentResourceName,  null, 'v1beta1');
    }
    
    deleteResource(resourceName) {
        return this
            .invokeRequestHandler('DELETE', resourceName,  null, 'v1beta1')
            .then(() => undefined);
    }
    pollRemoteOperationWithExponentialBackoff(operationResourceName) {
        const poller = new api_request_1.ExponentialBackoffPoller();
        return poller.poll(() => {
            return this.invokeRequestHandler('GET', operationResourceName,  null)
                .then((responseData) => {
