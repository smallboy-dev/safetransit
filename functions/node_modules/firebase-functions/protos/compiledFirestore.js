            ...
            Struct.encode = function encode(message, writer) {
                ...
                if (message.fields != null && Object.hasOwnProperty.call(message, "fields"))
                    for (var keys = Object.keys(message.fields), i = 0; i < keys.length; ++i) {
                        ...
                        $root.google.protobuf.Value.encode(message.fields[keys[i]], writer.uint32(18).fork()).ldelim().ldelim();
                    }
                return writer;
            };
            ...
            ListValue.encode = function encode(message, writer) {
                ...
                if (message.values != null && message.values.length)
                    for (var i = 0; i < message.values.length; ++i)
                        $root.google.protobuf.Value.encode(message.values[i], writer.uint32(10).fork()).ldelim();
                return writer;
            };
                ...
                firestore.v1 = (function() {
                    ...
                    v1.DocumentEventData = (function() {
                        ...
                        DocumentEventData.encode = function encode(message, writer) {
                            if (!writer)
                                writer = $Writer.create();
                            if (message.value != null && Object.hasOwnProperty.call(message, "value"))
                                $root.google.events.cloud.firestore.v1.Document.encode(message.value, writer.uint32(10).fork()).ldelim();
                            if (message.oldValue != null && Object.hasOwnProperty.call(message, "oldValue"))
                                $root.google.events.cloud.firestore.v1.Document.encode(message.oldValue, writer.uint32(18).fork()).ldelim();
                            if (message.updateMask != null && Object.hasOwnProperty.call(message, "updateMask"))
                                $root.google.events.cloud.firestore.v1.DocumentMask.encode(message.updateMask, writer.uint32(26).fork()).ldelim();
                            return writer;
                        };
                        ...
                        DocumentMask.encode = function encode(message, writer) {
                            ...
                            if (message.fieldPaths != null && message.fieldPaths.length)
                                for (var i = 0; i < message.fieldPaths.length; ++i)
                                    writer.uint32(10).string(message.fieldPaths[i]);
                            return writer;
                        };
                        ...
                        Document.encode = function encode(message, writer) {
                            ...
                            if (message.fields != null && Object.hasOwnProperty.call(message, "fields"))
                                for (var keys = Object.keys(message.fields), i = 0; i < keys.length; ++i) {
                                    ...
                                    $root.google.events.cloud.firestore.v1.Value.encode(message.fields[keys[i]], writer.uint32(18).fork()).ldelim().ldelim();
                                }
                            if (message.createTime != null && Object.hasOwnProperty.call(message, "createTime"))
                                $root.google.protobuf.Timestamp.encode(message.createTime, writer.uint32(26).fork()).ldelim();
                            if (message.updateTime != null && Object.hasOwnProperty.call(message, "updateTime"))
                                $root.google.protobuf.Timestamp.encode(message.updateTime, writer.uint32(34).fork()).ldelim();
                            return writer;
                        };
                    ...
                    v1.Value = (function() {
                        ...
                        Value.encode = function encode(message, writer) {
                            ...
                            if (message.mapValue != null && Object.hasOwnProperty.call(message, "mapValue"))
                                $root.google.events.cloud.firestore.v1.MapValue.encode(message.mapValue, writer.uint32(50).fork()).ldelim();
                            if (message.geoPointValue != null && Object.hasOwnProperty.call(message, "geoPointValue"))
                                $root.google.type.LatLng.encode(message.geoPointValue, writer.uint32(66).fork()).ldelim();
                            if (message.arrayValue != null && Object.hasOwnProperty.call(message, "arrayValue"))
                                $root.google.events.cloud.firestore.v1.ArrayValue.encode(message.arrayValue, writer.uint32(74).fork()).ldelim();
                            if (message.timestampValue != null && Object.hasOwnProperty.call(message, "timestampValue"))
                                $root.google.protobuf.Timestamp.encode(message.timestampValue, writer.uint32(82).fork()).ldelim();
                            if (message.nullValue != null && Object.hasOwnProperty.call(message, "nullValue"))
                    ...
                    v1.ArrayValue = (function() {
                        ...
                        ArrayValue.encode = function encode(message, writer) {
                            ...
                            if (message.values != null && message.values.length)
                                for (var i = 0; i < message.values.length; ++i)
                                    $root.google.events.cloud.firestore.v1.Value.encode(message.values[i], writer.uint32(10).fork()).ldelim();
                            return writer;
                        };
